package com.urbano.promocion.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String,String>> notFound(PromocionNotFoundException e){return ResponseEntity.status(HttpStatus.NOT_FOUND).body(Map.of("error",e.getMessage()));}
