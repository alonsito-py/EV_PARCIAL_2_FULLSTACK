...
public class GlobalExceptionHandler {
    @ExceptionHandler(MarketingNotFoundException.class)
    public ResponseEntity<Map<String,String>> notFound(MarketingNotFoundException e){return ResponseEntity.status(HttpStatus.NOT_FOUND).body(Map.of("error",e.getMessage()));}
