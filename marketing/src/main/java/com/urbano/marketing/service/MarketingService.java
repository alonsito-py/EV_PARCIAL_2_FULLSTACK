...
public class MarketingService {
    ...
    public CampaniaSocial getById(Long id) { return repo.findById(id).orElseThrow(()->new MarketingNotFoundException("Campania no encontrada id: "+id)); }
    public CampaniaSocial crear(CampaniaDTO dto) {
        log.info("Creando campania: {} red: {}", dto.getNombre(), dto.getRed());
    ...
    public CampaniaSocial publicar(Long id) { log.info("Publicando campania id: {}", id); CampaniaSocial c=getById(id); c.setEstado("PUBLICADA"); return repo.save(c); }
}