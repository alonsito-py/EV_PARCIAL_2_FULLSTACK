...
import com.urbano.pago.exception.PagoNotFoundException;
...
public class PagoService {
    ...
    private void actualizarEstadoPedido(Long pedidoId, String estado) {
    ...
    public TransaccionPago procesarPago(PagoDTO dto) {
        ...
        if (aprobado) { log.info("Pago aprobado pedido: {}", dto.getPedidoId()); actualizarEstadoPedido(dto.getPedidoId(),"PAGADO"); }
