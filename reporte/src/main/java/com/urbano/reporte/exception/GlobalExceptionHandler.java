...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String,String>> notFound(ReporteNotFoundException e){return ResponseEntity.status(HttpStatus.NOT_FOUND).body(Map.of("error",e.getMessage()));}
